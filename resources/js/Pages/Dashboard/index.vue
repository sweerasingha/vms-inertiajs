                  ...
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        ...
                        <h5 class="font-weight-bolder">{{ total_materials }}</h5>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        ...
                        <h5 class="font-weight-bolder">{{ total_boms }}</h5>
                      </div>
                    </div>
                    <div class="col-4 text-end">
                      <div
                      ...
                      >
                        <i
                          class="text-lg ni ni-money-coins opacity-10"
                          aria-hidden="true"
                        ></i>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        ...
                        <h5 class="font-weight-bolder">{{ total_vendors }}</h5>
                      </div>
                    </div>
                    <div class="col-4 text-end">
                      <div
                      ...
                      >
                        <i
                          class="text-lg ni ni-paper-diploma opacity-10"
                          aria-hidden="true"
                        ></i>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        ...
                        <h5 class="font-weight-bolder">{{ total_pos }}</h5>
                      </div>
                    </div>
                    <div class="col-4 text-end">
                      <div
